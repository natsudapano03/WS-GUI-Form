...
title = ttk.Combobox(personal_info_frame, values=["กลุ่มน้อย", "นาย", "นาง", "นางสาว"])
title.grid(row=0, column=1, padx=5, pady=5)

# Firts
ttk.Label(personal_info_frame, text="กรุณาใส่ชื่อ:").grid(row=1, column=0, padx=5, pady=5, sticky="e")
first_name = ttk.Entry(personal_info_frame)
first_name.grid(row=1, column=1, padx=5, pady=5)

# Last 
ttk.Label(personal_info_frame, text="กรุณาใส่นามสกุล:").grid(row=2, column=0, padx=5, pady=5, sticky="e")
...
# Address
ttk.Label(personal_info_frame, text="กรุณาใส่หมายเลขโทรศัพท์:").grid(row=5, column=0, padx=5, pady=5, sticky="e")
address = ttk.Entry(personal_info_frame)
address.grid(row=5, column=1, padx=5, pady=5)

# Phone Number
ttk.Label(personal_info_frame, text="กรุณาใส่ที่อยู่:").grid(row=6, column=0, padx=5, pady=5, sticky="e")
phone = ttk.Entry(personal_info_frame)
phone.grid(row=6, column=1, padx=5, pady=5)

ttk.Label(personal_info_frame, text="กรุณากรอกอำเภอ:").grid(row=7, column=0, padx=5, pady=5, sticky="e")
description = ttk.Entry(personal_info_frame)
description.grid(row=7, column=1, padx=5, pady=5)

ttk.Label(personal_info_frame, text="กรุณาใส่จังหวัด:").grid(row=8, column=0, padx=5, pady=5, sticky="e")
id_card = ttk.Entry(personal_info_frame)
id_card.grid(row=8, column=1, padx=5, pady=5)

# Password
ttk.Label(personal_info_frame, text="กรุณาใส่รหัสไปรษณย์:").grid(row=9, column=0, padx=5, pady=5, sticky="e")
password = ttk.Entry(personal_info_frame, show="*")
